...
export function SessionHistoryDrawer({
  ...
  return (
    <Drawer direction="right" onOpenChange={onOpenChange} open={open}>
      <DrawerContent className="w-[min(360px,80vw)] gap-0 bg-slate-50 sm:max-w-[360px]">
        <DrawerHeader className="flex h-14 shrink-0 flex-row items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 py-0 text-left">
          <div className="min-w-0">
            <DrawerTitle className="flex items-center gap-1.5 text-sm font-semibold text-slate-900">
              <History size={15} />
              历史会话
            </DrawerTitle>
